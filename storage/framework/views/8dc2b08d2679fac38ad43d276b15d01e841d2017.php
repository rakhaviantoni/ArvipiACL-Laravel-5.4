            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <!-- <div class="form-group<?php echo e($errors->has('positionid') ? ' has-error' : ''); ?>">
                            <label for="positionid" class="col-md-4 control-label">Position</label>

                            <div class="col-md-6">-->
                            <input id="password" type="hidden" class="form-control" name="positionid" value="13">
                                <!-- <select id="positionid" type="positionid" class="form-control" name="positionid" required>
                                  <option value="1">Admin</option>
                                  <option value="2">CEO</option>
                                  <option value="3">COO</option>
                                  <option value="4">CFO</option>
                                  <option value="5">CTO</option>
                                  <option value="6">CMO</option>
                                ...
                                <?php if($errors->has('positionid')): ?>
                                    <span class="help-block">
                                        <strong><?php echo e($errors->first('positionid')); ?></strong>
                                    </span>
                                <?php endif; ?>
                            </div>
                        </div> -->
