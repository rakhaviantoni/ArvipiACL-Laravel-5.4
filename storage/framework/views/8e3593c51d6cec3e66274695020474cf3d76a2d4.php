                ...
                <div class="links">
                    ...
                    <div id="myTabContent" class="col-md-12 tab-content">
                      ...
                      <div class="tab-pane fade" id="press">
                        <?php $__currentLoopData = $press; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $press): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="panel panel-primary">
                          <div class="panel-heading">
                            <h3 class="panel-title"><?php echo e($press->title); ?> on <?php echo e(Carbon\Carbon::parse($press->created_at)->toFormattedDateString()); ?> by <?php echo e($press->user->username); ?></h3>
                          </div>
